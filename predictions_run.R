...
season <- "20/21"
round <- "19"
tips_path <- "BeatTheRobot/Beat the robot - Round 19 (Antworten) - Formularantworten 1.csv"
...
#Adaptions
games <- c(3432807,3432808,3432813)
missing_matches <- c(3432812,3496601,3432818)
